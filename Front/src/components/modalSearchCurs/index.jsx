...
export default function ModalSearchCurs({ isOpen, onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:8000/api/curs/id/${formData.id}`, {
                headers: {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {searchResult && (
                        <div className="search-result">
                            ...
                            <p>Tipo: {searchResult.tipo_de_curso}</p>
                            <p>Carga Horaria: {searchResult.carga_horaria_curso}</p>
                        </div>
                    )}
